...
export default function Navbar() {
    return (
        <div className="flex justify-between items-center shadow-lg py-6 px-8">
            ...
            <NavLink to="/upload"><button className="bg-[#115987] text-white px-4 py-3 rounded-3xl font-extralight text-sm hover:text-[#d6d1d1] hover:shadow-xl">Add Patient Record</button></NavLink>
        </div>
    );
}